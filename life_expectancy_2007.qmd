...
highest_life_exp_country <- gap_o7 %>% 
  arrange(-lifeExp) %>%
  head(1) %>% 
  pull(country)
...
lowest_life_exp_country <- gap_o7 %>% 
  arrange(lifeExp) %>%
  head(1) %>% 
  pull(country)
...
value_box(
  ...
  theme = value_box_theme(bg = "#5D83DF"),
...
value_box(
  ...
  theme = value_box_theme(bg = "#22335C"),
...
value_box(
  ...
  theme = value_box_theme(bg = "#6790C2"),
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/hVimVzgtD6w?si=fRQi-e5xgeAWYdZn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
